...
def xblock_resource_pkg(block):
    """
    Return the module name need to find an XBlock's shared static assets.
    ...
    XBlock-style of asset specification If they use the XModule bundling part of
    the asset pipeline (xmodule_assets), their assets are compiled through an
